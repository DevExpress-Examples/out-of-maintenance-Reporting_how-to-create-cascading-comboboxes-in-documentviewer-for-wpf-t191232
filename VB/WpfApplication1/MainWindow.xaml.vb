    ...
    Partial Public Class MainWindow
        ...
        Private Sub model_CustomizeParameterEditors(ByVal sender As Object, ByVal e As CustomizeParameterEditorsEventArgs)
            ...
            If e.Parameter.Name = "CategoryID" Then
                ...
                AddHandler editor.EditValueChanged, AddressOf editor_EditValueChanged
                e.BoundDataMember = "EditValue"
                e.Editor = editor

            End If
            If e.Parameter.Name = "ProductID" Then
                Dim editor As New ComboBoxEdit()
        ...
        Private Sub editor_EditValueChanged(ByVal sender As Object, ByVal e As DevExpress.Xpf.Editors.EditValueChangedEventArgs)
            If e.NewValue <> e.OldValue Then
                report.productsTableAdapter.FillByCatID(ds.Products, CType(e.NewValue, Integer?))
            End If
        End Sub
    End Class
End Namespace
